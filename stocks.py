...
blueCategory = "HEXO AAL APA BA GRPN OAS OXY ZM IVV AMC DAL XOM HTZ LUV HAL M DIS GILD CLNY TWTR AAPL MSFT GES SPG ERJ QEP CPE IVR CBL CDEV KOS GCI DO NCLH GE TWTR NBR LTM CRC CHK TELL AXP JPM TLRD MFA TGI SPCE WPG WLL DNR"
...
for result in stockResults:
    ...
    categoriesClasses = 'blue-category' if (result.stockSymbol in blueCategory) else ''

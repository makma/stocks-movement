...
blueCategory = "AAL APA BA GRPN OAS OXY ZM IVV AMC DAL XOM HTZ LUV HAL M DIS GILD CLNY TWTR AAPL MSFT GES SPG ERJ QEP CPE IVR CBL CDEV KOS GCI DO NCLH GE TWTR NBR LTM CRC CHK TELL AXP JPM TLRD MFA TGI SPCE WPG WLL DNR"
